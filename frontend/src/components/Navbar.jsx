...
export default function Navbar() {
    ...
    return (
        <div className="w-full border-b bg-background/70 backdrop-blur supports-[backdrop-filter]:bg-background/40">
                            ...
                            <NavigationMenuContent>
                                <ul className="grid w-[300px] gap-4 p-2">
                                    <li className="space-y-2">
                                        <NavigationMenuLink asChild>
                                            <Link href="#" className="block rounded-md p-2">
    ...
    return (
        <li {...props}>
            <NavigationMenuLink asChild>
                <Link
                    href={href}
                    className="block rounded-md p-3 no-underline outline-none transition-colors hover:bg-muted focus:bg-muted"
                >
